...
- `--auto` — MAFFT თავად არჩევს შესაბამის სტრატეგიას; განსხვავებული მიზნებისთვის შესაძლოა კონკრეტული რეჟიმი იყოს უმჯობესი, mafft-ის README-ში შეგიძლიათ იხილოთ რეჟიმები
- `--thread -1` — იყენებს ხელმისაწვდომ CPU threads-ს; თუ კონკრეტული რაოდენობა გჭირდებათ thread-ების, -1-ის მაგივრად მიუთითეთ შესაბამისი რიცხვი. რაც უფრო მაღალ რიცხვს უთითებთ, მით მეტი რესურსი იხარჯება CPU-სი, თუ პარალელურად სხვა პროგრამები გაქვთ გაშვებული შესაძლოა პრობლემები გამოიწვიოს.
